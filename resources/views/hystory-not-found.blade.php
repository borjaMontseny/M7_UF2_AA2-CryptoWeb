    ...
    <div class="h-screen w-screen bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                ...
                <p class="text-2xl md:text-3xl font-light leading-normal">Ho sentim, no podem trobar aquesta pàgina.</p>
                <p class="mb-8">Però no et preocupis, pots trobar moltes altres coses a la nostra pàgina d'inici.</p>

                <a href="{{ route('criptos') }}"
                    class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">tornar
